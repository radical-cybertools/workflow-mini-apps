...
class MVP(object):
    ...
    def run_mpi_sweep_hdf5_py(self, phase_idx):
        ...
        t.executable = 'python'
        t.arguments = ['/home/twang3/myWork/miniapp-exalearn/RECUP/mini-apps/ExaLearn/Executables/mini-mpi_sweep_hdf5_theta.py', # TODO change this!
    ...
    def run_mtnetwork_training_horovod_py(self, phase_idx):
        ...
        t.executable = 'python'
        t.arguments = ['/home/twang3/myWork/miniapp-exalearn/RECUP/mini-apps/ExaLearn/Executables/test_training.py', # TODO change this!
                       '--data_root_dir={}'.format(self.args.data_root_dir),
...
#        'queue'   : 'default',
        ...
        'cpus'    : 64 * n_nodes,
        'gpus'    : 0 * n_nodes,
        'project' : 'ProjectID' # Project Id needs to be entered here.
        })
    mvp.run_workflow()
