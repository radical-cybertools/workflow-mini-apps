...
class MVP(object):
    ...
    def set_argparse(self):
        parser = argparse.ArgumentParser(description="Exalearn_miniapp_EnTK")
    ...
    def run_mpi_sweep_hdf5_py(self, phase_idx):
        ...
        t.executable = 'python'
        t.arguments = ['/home/twang3/myWork/miniapp-exalearn/RECUP/mini-apps/ExaLearn/Executables/mini-mpi_sweep_hdf5_theta.py', # TODO Relative Path
    ...
    def run_mtnetwork_training_horovod_py(self, phase_idx):
        ...
        t.executable = 'python'
        t.arguments = ['/home/twang3/myWork/miniapp-exalearn/RECUP/mini-apps/ExaLearn/Executables/test_training.py', # TODO Relative Path
                       '--data_root_dir={}'.format(self.args.data_root_dir),
...
#        'queue'   : 'default',
        ...
        'cpus'    : 64 * n_nodes,
        'gpus'    : 0 * n_nodes,
        'project' : 'Ptoject_ID' #Project ID needs to be entered here
        })
    mvp.run_workflow()
