...
#        for phase in range(int(self.args.num_phases)):
        s1 = entk.Stage()
        s1.add_tasks(self.run_sim(phase))
        s2 = entk.Stage()
        s2.add_tasks(self.run_train(phase))
        s2.add_tasks(self.run_sim(phase))
        s3 = entk.Stage()
        s3.add_tasks(self.run_selection(phase))
        s4 = entk.Stage()
        s1.add_tasks(self.run_agent(phase))
        s5 = entk.Stage()
        s5.add_tasks(self.run_train(phase))
        s5.add_tasks(self.run_sim(phase))
        s6 = entk.Stage()
        s6.add_tasks(self.run_selection(phase))
        s7 = entk.Stage()
        s7.add_tasks(self.run_agent(phase))
        s8 = entk.Stage()
        s8.add_tasks(self.run_train(phase))
        s9 = entk.Stage()
        s9.add_tasks(self.run_selection(phase))
        s10 = entk.Stage()
        s10.add_tasks(self.run_agent(phase))
